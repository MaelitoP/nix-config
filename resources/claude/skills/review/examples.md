...
- **File:** `src/Ingestor/Listening/Domain/Aggregate/Search/Command/UpdateSearchHandler.php:41`
...
- **File:** `src/Ingestor/Listening/Domain/Aggregate/Search/SearchUpdater.php:12`
...
- **File:** `tests/Ingestor/Listening/Domain/Aggregate/Search/Command/DisableSearchHandlerTest.php:1`
